                ...
                <div className="footer__bg">
                    <div className="footer__large">
                        ...
                        <div className="social__buttons">
                            ...
                            <a href="https://www.youtube.com/channel/UCE4fUc_1EDWr4YTj2w_eaWA" target="_blank" rel="noopener noreferrer" className="icon__social"><i className="fab fa-youtube"></i></a>
