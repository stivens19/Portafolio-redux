    ...
    return (
        <section className="contact__container p-main-service" id="contact">
            ...
            <form className="contact__form" name="contact" method="post">
                ...
                <input type="text" className="contact__form-input" placeholder="Ingrese su Nombre" name="nombre" />
                <input type="email" className="contact__form-input" placeholder="Ingrese su Email" email="email" />
                </div>
                
                <input type="text" className="contact__form-input" placeholder="Ingrese el Asunto" name="asunto" />
                <textarea cols="30" className="contact__form-input" rows="10" placeholder="Ingrese Mensaje" name="mensaje"></textarea>
