        ...
        <div className=" p-main banner__container animate__animated animate__fadeIn">
            <div className="banner__item">
                ...
                <div className="banner__description mt-2">
                    ...
                    <p>🚀Soy un desarrollador web apasionado por el mundo tecnológico y la programación. </p>
                    <div className="banner__buttons">
                        <a href="./" className="btn banner__button">Descargar CV</a>
                        <a href="./https://api.whatsapp.com/send?phone=51931340718" className="btn banner__button-whatsapp"><i className="fab fa-whatsapp"></i></a>
                    </div>
                </div>
            </div>
